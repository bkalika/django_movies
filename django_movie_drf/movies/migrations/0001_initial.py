    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('tagline', models.CharField(default='', max_length=100, verbose_name='Tag line')),
                ('description', models.TextField(verbose_name='Description')),
                ...
                ('budget', models.PositiveIntegerField(default=0, help_text='input price in $', verbose_name='Budget')),
                ('fees_in_usa', models.PositiveIntegerField(default=0, help_text='input price in $', verbose_name='Fees in USA')),
                ('fees_in_world', models.PositiveIntegerField(default=0, help_text='input price in $', verbose_name='Fees in the world')),
                ('url', models.SlugField(max_length=160, unique=True)),
